...
/**
 * Representa um estado do mundo: onde estao as rainhas
 */
public class EstadoRainhas implements Estado, Heuristica, Aleatorio {
    ...
    public int h() {
        ...
        for (short r=0;r<tam;r++) { // para cada rainha
            ...
            for (int c=0; c<tam; c++) {
                ...
                if (naPos != -1) { // nao esta livre
                    if (naPos != r) { // nao e r que esta la
                        ataques++;
                    }
                }
            }
            ...
            // testa as diagonais secundarias
    ...
    public static void main(String[] a) {
        ...
        Estado inicial = new EstadoRainhas(); // um estado aleatorio
        System.out.println("Estado inicial:"+inicial+"\n");

        Nodo n = null;
        // os tras metodos seguintes nao conseguem
