...
public class MissionarioCanibal implements Estado, Antecessor{
    ...
    public void levar1m(List<Estado> suc){
        //Se o barco estiver do lado esquerdo e houver pelo menos 1 missionario nesse lado
        if (barco == 'e' && missionario > 0){
            ...
            //Verifica se o sucessor gerado e valido
            if (novo.ehValido())
                //Se for valido, adiciona na lista de sicessores
                suc.add(novo);
        } else {
            //Se o barco estiver do lado direto e Houver pelo menos 1 missionario neste lado
    ...
    public void levar2m(List<Estado> suc){
        ...
        if (barco == 'e' && missionario > 1){
            ...
            //Se o barco estiver do lado direito e houver dois missionarios deste lado
    ...
    public void levar1m1c(List<Estado> suc){
        //Se o barco estiver do lado esquerdo e houver pelo menos um missionario e um canibal deste lado
        if (barco == 'e' && missionario > 0 && canibal > 0){
            ...
            //Se o barco estiver do lado direito e houver pelo menos um missionario e um canibal deste lado
    ...
    public static void main(String[] a) throws IOException, Exception {
        ...
        while (!str.equals("S")){
            if (str.equals("1")){
                ...
                n = new BuscaLargura<MissionarioCanibal>().busca(inicial);
            }else{
                if (str.equals("2")){
                    System.out.println("Busca em Profundidade");
                    n = new BuscaProfundidade<MissionarioCanibal>(20).busca(inicial);
                }else{
                    if (str.equals("3")){
                        System.out.println("Busca em Profundidade Iterativo");
                        n = new BuscaIterativo<MissionarioCanibal>().busca(inicial);
                    }else
                        if (str.equals("4")){
                            System.out.println("Busca Bidirecional");
                            n = new BuscaBidirecional<MissionarioCanibal>().busca(inicial,finau);
                        }
                }
            }
    ...
    /** Verifica se um estado e igual a outro ja inserido na lista de sucessores (usado para poda) */
