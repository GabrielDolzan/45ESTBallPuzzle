...
public class EstadoJarros implements Estado {
    ...
    public static void main(String[] a) throws Exception {
        ...
        Nodo n = new BuscaLargura<EstadoJarros>().busca(inicial);
        if (n == null) {
        ...
        n = new BuscaProfundidade<EstadoJarros>(15).busca(inicial);
        if (n == null) {
            System.out.println("sem solucao!");
        } else {
            System.out.println("profundidade" + n.getProfundidade());
       ...
       /* System.out.println("busca em profundidade iterativo");
        n = new BuscaIterativo<EstadoJarros>().busca(inicial);
        if (n == null) {
            System.out.println("sem solucao!");
        } else {
            System.out.println("solucao:\n" + n.montaCaminho() + "\n\n");
